    ...
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.income}>
                ...
                <TextInput style={styles.input_income}
        ...
        <View style={styles.income}>
                ...
                />:  <View style={styles.photo_check_date}/>}
                  ...
                  <Text style = {styles.txt_insurance}>Trên lương{'\n'}chính thức </Text>
                </TouchableOpacity>
        ...
        <View style={styles.income}>
                ...
                <Text> : </Text>
                <TouchableOpacity onPress={onCheck_r1}
                style={styles.btn_region}>
                  {check_region===1? <Image
                  style={styles.photo_check_date}
                  source={require('../assets/doneCircle.png')}
                />:<View style={styles.photo_check_date}/> }
                <Text style = {styles.txt_so}>I</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={onCheck_r2}
                style={styles.btn_region}>
                  {check_region===2 ? <Image
                  style={styles.photo_check_date}
                  source={require('../assets/doneCircle.png')}
                />: <View style={styles.photo_check_date}/>}
                ...
                <TouchableOpacity onPress={onCheck_r3}
                style={styles.btn_region}>
                  {check_region===3 ?<Image
                  style={styles.photo_check_date}
                  source={require('../assets/doneCircle.png')}
                />: <View style={styles.photo_check_date}/>}
                ...
                <TouchableOpacity onPress={onCheck_r4}
                style={styles.btn_region}>
                  {check_region===4?  <Image
                  style={styles.photo_check_date}
                  source={require('../assets/doneCircle.png')}
                />: <View style={styles.photo_check_date}/> }            
        ...
        <View style={styles.income}>
                ...
                <TextInput style={styles.input_npt}
                            keyboardType = "numeric"
                            value = {soNpt}
        ...
        <View style={styles.btn_}>
                <TouchableOpacity  onPress={()=> grossToNet(navigation)}
                style={styles.btn_ok} >
                  <Text style={styles.txt_btn}>GROSS ➙ NET</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=> netToGross(navigation)}
